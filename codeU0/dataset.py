...
class CheXpertDataSet(Dataset):
    def __init__(self, data_dir, image_list_file, transform=None):
        ...
        df = df.fillna(0)
        label_names_0 = [ 'No Finding', 'Enlarged Cardiomediastinum', 'Cardiomegaly', 'Lung Opacity', 'Lung Lesion', 'Edema', 'Consolidation',
        ...
        for i, row in df.iterrows():
            ...
            label = list(row[5:].values) # convert uncertain -1 to positive 1
